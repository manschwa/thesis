...
Das Etherpad Plugin ist ein weiteres Modul durch das ein externes Programm (Etherpad) mit Hilfe eines \texttt{iframe}
in Stud.IP eingebunden wird.\\
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=400px]{images/pad_iframe.jpeg}
